...
**Live demo**: [qpingwin-bible-rag-chatbot.hf.space](https://qpingwin-bible-rag-chatbot.hf.space) - UI + interactive API docs at [/docs](https://qpingwin-bible-rag-chatbot.hf.space/docs). Hosted generation uses gpt-oss-120b via Groq, the project runs fully locally via Ollama (below).
